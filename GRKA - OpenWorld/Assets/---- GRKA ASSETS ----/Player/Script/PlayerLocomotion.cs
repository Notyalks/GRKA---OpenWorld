...
public class PlayerLocomotion : MonoBehaviour
{
    ...
    public float idleTimeThreshold = 5f; // Tempo em segundos para transição para Idle 2
    private float idleTimer;
    private bool isIdle2;
    private bool idle2Triggered; // Estado para verificar se a animação Idle 2 foi ativada
    ...
    {
        if (climbState == 4) // Já chegou ao topo
        {
            HandleReachTop();
            return;
        }
    ...
    {
        // Ajusta a posição do jogador para o topo da escada, mas permite que continue escalando
