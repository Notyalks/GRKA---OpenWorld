...
public class HealthBoxMissao : MonoBehaviour
{
        ...
        if (other.CompareTag("Player") && interacaoAtivada)
        {
            ...
            if (Input.GetKeyDown(KeyCode.E) && !IsGamePaused())
            {
                ...
                if (playerManager != null)
                {
                    ...
                    // Concluir o objetivo "Recarregue a bateria na cápsula"
                    ObjectiveSystem.Instance.CompleteObjective("Recarregue a bateria na cápsula.");
                }
            }
        }
    }
